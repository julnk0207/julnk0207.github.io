...
description: "To make a sequence data, we use windows. If we want to use past 56 days as a train data, use 56 days-length window to split the past data, and use the next value of each window…"
date: 2025-01-02
category: "Book"
