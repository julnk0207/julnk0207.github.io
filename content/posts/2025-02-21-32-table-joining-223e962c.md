...
description: "Product set(or Cartesian product) is multipling two sets. If set X has elements"
date: 2025-02-21
category: "Book"
...
Product set(or Cartesian product) is multipling two sets. If set X has elements
...
and set Y has 1, 2, 3, the result of product will become as a following image.
...
> 
> 
> The two columns used above were all primary keys. However, there are also cases that a column of one table to use is not a primary key. n this case, a column of the other table is called `foreign key`.
> 
