---
title: "[[MIT] Introduction to Computational Thinking and Data Science] Chapter 14. Classification and Statistical Sins"
description: "지난 시간에 사용한 타이타닉 예시로 k-최근접 분류(KNN)와 로지스틱 회귀의 성능 비교를 할 수 있다."
date: 2023-02-25
...
또다른 수법으로는 집단을 조작하는 것이다.

~~왠지 점점 조작 방법 소개가 되는 것 같다~~

아래 그래프는 복지기금을 수령하는 미국인들의 수를 나타낸 것이다.
...
이 표의 네 부분은 모두 동일한 평균, 분산, 선형회귀 모델(
