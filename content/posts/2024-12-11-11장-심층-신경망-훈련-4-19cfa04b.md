...
description: "선형 모델의 비용 함수에 적용한 l 1, l 2 규제처럼 신경망에서도 이를 적용할 수 있다."
date: 2024-12-11
category: "Book"
...
선형 모델의 비용 함수에 적용한 *l*1, *l*2 규제처럼 신경망에서도 이를 적용할 수 있다.
...
*l*1 규제를 적용하고 싶다면 `tf.keras.regularizers.l1`, 둘 다 적용하고 싶다면 `tf.keras.regularizers.l1_l2`를 사용한다.
...
Max-norm 규제는 각각의 뉴런에 대해 입력의 연결 가중치 $\bf{w}$ 가 $\vert \vert \bf{w} \vert \vert_2 \leq r$ 이 되도록 제한한다. r은 max-norm 하이퍼파라미터이고, ||⋅||2 은 *l*2 norm을 의미한다.
