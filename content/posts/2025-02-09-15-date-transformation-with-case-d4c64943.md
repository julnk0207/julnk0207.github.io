...
description: "CASE is used to transform data in a desired way. For example, transform 0/1 to ‘man’/‘woman’."
date: 2025-02-09
category: "Book"
...
- To use NULL as a condition, only searched CASE will work. (It is because simple CASE use ‘=’ to check the equality.)
