...
description: "이번 강의에서는 3가지 dataset을 이용해서 신경망을 어떻게 학습시키는지를 실습하였다. MNIST: 손글씨 dataset fashion MNIST: 패션(의류) 관련 dataset IMDB: 영화 리뷰 dataset. 긍정적 리뷰인지 부정적 리뷰인지를 판별."
date: 2024-11-11
