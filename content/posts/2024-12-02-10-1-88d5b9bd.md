...
description: "퍼셉트론(Perceptron)은 가장 간단한 인공 신경망 구조이다. 퍼셉트론은 TLU(Threshold Logic Unit)라고 불리는 인공 뉴런을 기반으로 한다."
date: 2024-12-02
category: "Book"
...
*wi*, *jnext* *step* = *wi*, *j* + *η*(*yi* − *ŷi*)*xi*

*wi*, *j* 는 i번째 입력 뉴런과 j번째 출력 뉴런 사이를 연결하는 가중치이다. 실제 값과 예측 값 간의 차이에 학습률 *η* 를 이용해 가중치를 업데이트 한다.
