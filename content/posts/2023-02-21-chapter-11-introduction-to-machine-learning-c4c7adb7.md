---
title: "[[MIT] Introduction to Computational Thinking and Data Science] Chapter 11. Introduction to Machine Learning"
description: "머신러닝은 컴퓨터가 스스로 학습하게 하는 것을 의미한다. 프로그래머가 코딩으로 프로그램을 만들고 데이터를 입력해 결과를 내는 것이 전통적인 프로그래밍이었다면, 다양한 데이터와 정답(결과)을 컴퓨터에게 주고 이를 이용해 프로그램을 만들어 내는 것이 머신러닝인 것이다."
date: 2023-02-21
