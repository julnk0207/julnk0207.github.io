---
title: "[[MIT] Introduction to Computational Thinking and Data Science] Chapter 10. Understanding Experimental Data"
description: "모든 일을 목적을 가지고 진행되어야 한다. 우리가 모델을 만드는 이유는 두 가지가 있다. 데이터가 생성된 과정을 이해하기 위해 (ex. 훅의 법칙 구하기) 예측하기 위해 (ex. 날씨 예측, 선거 결과 예측)"
date: 2023-02-20
