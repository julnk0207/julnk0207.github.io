---
title: "[[MIT] Introduction to Computational Thinking and Data Science] Chapter 7. Confidence Intervals"
description: "정규분포는 확률밀도함수(PDFs)로 정의된다. 확률밀도함수에서는 확률 변수가 두 값 사이의 구간에 있을 확률을 구할 수 있다. 바로 ’적분’을 이용해서다. 그래프에서 살펴보면, 그래프 아래의 면적이 해당 구간에 존재할 확률을 가리킨다."
date: 2023-02-16
...
원주율 파이(*π*)를 추정하기 위해 매우 많은 수학자들이 오랜 시간 노력해왔다. 그 중 ’뷔퐁-라플라스’는 조금 특이한 방법을 채택했다.
...
수식의 원의 넓이에 공식을 대입하면 *π*값을 구할 수 있을 것이다. (교수님이 직접 ~~대학원생들을 세워놓고~~ 실험한 동영상이 있다….)
