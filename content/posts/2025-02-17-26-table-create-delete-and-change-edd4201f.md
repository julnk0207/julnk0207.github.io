...
description: "For column definition, you need to define the name, datatype, default and null availability."
date: 2025-02-17
category: "Book"
...
1. Adding Column
    ...
    `sql     ALTER TABLE table_name ADD col_def`
...
2. Changing Properties of Columns
