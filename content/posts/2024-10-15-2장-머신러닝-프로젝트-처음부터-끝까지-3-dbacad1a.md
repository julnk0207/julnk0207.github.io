...
description: "Test set을 이용해서 모델을 훈련하고 평가할 수 있다. 본 예시에서는 LinearRegression, DecisionTreeRegressor, RandomForestRegressor의 3개 모델을 사용하였다."
date: 2024-10-15
category: "Book"
...
그리드 서치는 시도해볼 값을 지정해서 수동으로 조합을 평가해보는 것이다. 예를 들어 하이퍼파라미터 A에 대해 3개의 값을 시도해보고 싶고, B에 대해서는 2개를 시도하고 싶다면, 3 × 2 = 6 개의 조합을 시도해서 평가하게 된다.
