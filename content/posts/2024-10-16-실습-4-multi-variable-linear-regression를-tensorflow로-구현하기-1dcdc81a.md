...
description: "데이터를 작성하는 방식이 matrix로 변경되었다. 이에 따라 X와 y를 표현하는 방식도 바뀌었다. W와 b를 최초 지정하는 방식이 간단해졌다. 가설함수를 설정하는 과정에서 행렬 곱 tf.matmul()이 사용되었다. W와 b를 업데이트 하는 방식이 간단해졌다."
date: 2024-10-16
